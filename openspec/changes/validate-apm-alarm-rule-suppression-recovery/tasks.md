...
- [x] 2.2 Verify tests for project-scoped token headers, required business context, exact-target matching, approval/deadline rejection, bounded response capture, and credential redaction.
